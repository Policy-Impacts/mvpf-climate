...
local stoves = "cookstoves india_cs"
...
local categories = "stoves deforestation rice_burning international_rebates" 
 ...
 do "${github}/wrapper/metafile.do" ///
    ...
    "`4'" /// savings
    "`5'" /// profits
	"`stoves' `deforestation' `rice_burning' `international_rebates'" /// policies
	`6' /// reps
	"international_bootstraps" // name of run

foreach policy in `stoves' `deforestation' `rice_burning' `international_rebates' {
