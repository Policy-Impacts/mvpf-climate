...
preserve
	...
	** No Hawaii!!!
	if "`4'" == "baseline"{
		...
		forvalues y = 2011(1)2014{
			qui sum pop`y' if state == "Colorado"
			local CO_pop_`y' = r(mean)
			qui sum pop`y' if state == "Georgia"
			local GA_pop_`y' = r(mean)
			qui sum pop`y' if state == "Louisiana"
			local LA_pop_`y' = r(mean)
			qui sum pop`y' if state == "Maryland"
			local MD_pop_`y' = r(mean)
			qui sum pop`y' if state == "Oregon"
			local OR_pop_`y' = r(mean)
			qui sum pop`y' if state == "South Carolina"
			local SC_pop_`y' = r(mean)
            qui sum pop`y' if state == "Utah"
			local UT_pop_`y' = r(mean)
		}
		keep if state == "Colorado" | state == "Georgia" | state == "Louisiana" | state == "Maryland" | state == "Oregon" | state == "South Carolina" | state == "Utah"
...
preserve
	if "`4'" == "baseline"{
		...
		keep if state == "CO" | state == "GA" | state == "LA" | state == "MD" | state == "OR" | state == "SC" | state == "UT"
...
if "`4'" == "baseline"{
	* not including Hawaii for utility producer surplus or gov revenue
	forvalues y = 2011(1)2014{
		local util_gov_revenue_`y' = (`CO_pop_`y'' * ${government_revenue_`y'_CO} + `GA_pop_`y'' * ${government_revenue_`y'_GA} + `LA_pop_`y'' * ${government_revenue_`y'_LA} + `MD_pop_`y'' * ${government_revenue_`y'_MD} + `OR_pop_`y'' * ${government_revenue_`y'_OR} + `SC_pop_`y'' * ${government_revenue_`y'_SC} + `UT_pop_`y'' * ${government_revenue_`y'_UT}) ///
									/ (`CO_pop_`y'' + `GA_pop_`y'' + `LA_pop_`y'' + `MD_pop_`y'' + `OR_pop_`y'' + `SC_pop_`y'' + `UT_pop_`y'')
		local util_producer_surplus_`y' = (`CO_pop_`y'' * ${producer_surplus_`y'_CO}  + `GA_pop_`y'' * ${producer_surplus_`y'_GA} + `LA_pop_`y'' * ${producer_surplus_`y'_LA} + `MD_pop_`y'' * ${producer_surplus_`y'_MD} + `OR_pop_`y'' * ${producer_surplus_`y'_OR} + `SC_pop_`y'' * ${producer_surplus_`y'_SC} + `UT_pop_`y'' * ${producer_surplus_`y'_UT}) ///
									/ (`CO_pop_`y'' + `GA_pop_`y'' + `LA_pop_`y'' + `MD_pop_`y'' + `OR_pop_`y'' + `SC_pop_`y'' + `UT_pop_`y'')
	}
...
if "`4'" == "baseline"{
	...
	*** dynamic grid stuff
	...
	local ev_first_damages_g = (`ev_first_damages_g_CO'* `CO_pop_2011' + `ev_first_damages_g_GA' * `GA_pop_2011' + `ev_first_damages_g_LA' * `LA_pop_2011' + `ev_first_damages_g_MD' * `MD_pop_2011' + `ev_first_damages_g_OR' * `OR_pop_2011' + `ev_first_damages_g_SC' * `SC_pop_2011' + `ev_first_damages_g_UT' * `UT_pop_2011') / (`CO_pop_2011' + `GA_pop_2011' + `LA_pop_2011' + `MD_pop_2011' + `OR_pop_2011' + `SC_pop_2011' + `UT_pop_2011')
	local local_benefit = (`local_benefit_CO' * `CO_pop_2011' + `local_benefit_GA' * `GA_pop_2011' + `local_benefit_LA' * `LA_pop_2011' + `local_benefit_MD' * `MD_pop_2011' + `local_benefit_OR' * `OR_pop_2011' + `local_benefit_SC' * `SC_pop_2011' + `local_benefit_UT' * `UT_pop_2011') / (`CO_pop_2011' + `GA_pop_2011' + `LA_pop_2011' + `MD_pop_2011' + `OR_pop_2011' + `SC_pop_2011' + `UT_pop_2011')
	local global_benefit = (`global_benefit_CO' * `CO_pop_2011' + `global_benefit_GA' * `GA_pop_2011' + `global_benefit_LA' * `LA_pop_2011' + `global_benefit_MD' * `MD_pop_2011' + `global_benefit_OR' * `OR_pop_2011' + `global_benefit_SC' * `SC_pop_2011' + `global_benefit_UT' * `UT_pop_2011') / (`CO_pop_2011' + `GA_pop_2011' + `LA_pop_2011' + `MD_pop_2011' + `OR_pop_2011' + `SC_pop_2011' + `UT_pop_2011')
	local carbon_content = (`carbon_content_CO' * `CO_pop_2011' + `carbon_content_GA' * `GA_pop_2011' + `carbon_content_LA' * `LA_pop_2011' + `carbon_content_MD' * `MD_pop_2011' + `carbon_content_OR' * `OR_pop_2011' + `carbon_content_SC' * `SC_pop_2011' + `carbon_content_UT' * `UT_pop_2011') / (`CO_pop_2011' + `GA_pop_2011' + `LA_pop_2011' + `MD_pop_2011' + `OR_pop_2011' + `SC_pop_2011' + `UT_pop_2011')
...
if "${lbd}" == "yes"{
	...
	** --------------------- COST CURVE --------------------- **
	if "`4'" == "baseline"{
		...
		local dyn_enviro_local = `r(enviro_mvpf)' * (`enviro_ext' / `us_enviro_ext')

		cost_curve_masterfile, demand_elas(`epsilon') discount_rate(`discount') farmer(`farmer_theta') fcr(`fixed_cost_frac') ///
							   curr_prod(`marg_sales') cum_prod(`cum_sales') price(`net_msrp') enviro(ev_global) ///
							   start_year(`dollar_year') scc(${scc_import_check}) new_car(`lbd_cf') vmt(${EV_VMT_car_adjustment})
		local dyn_enviro_global_tot = `r(enviro_mvpf)' * (`enviro_ext' / `us_enviro_ext')
