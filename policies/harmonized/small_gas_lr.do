...
*https://www.economics.uci.edu/files/docs/workingpapers/2005-06/Small-03.pdf
*/
...
global `1'_ep = "N"
global `1'_name "Gasoline Tax (Price Elasticity from Small and Van Dender 2007)"
...
global note_`1' = `"Publication: Small and Van Dender 2007 - Long-run Elasticity" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'