*************************************************************************************
/*       0. Program: Incentive Payments for Weatherization Program - High        */
*************************************************************************************
...
****************************************************
	...
	****************************************************
	...
	local contractor_surplus = 99 * (${cpi_`dollar_year'}/${cpi_2017})
...
local gov_carbon = `carbon' + ((${global_mmbtu_`dollar_year'} * `mmbtu_reduction_marginal' * `retrofit_lifespan' * `r_ng')/${sc_CO2_`dollar_year'})
