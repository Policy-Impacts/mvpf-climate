...
*https://www.sciencedirect.com/science/article/pii/S030142151000546X
*/
...
global `1'_ep = "N"
global `1'_name "Gasoline Tax (Price Elasticity from Sentenac-Chemin 2012)"
...
global note_`1' = `"Publication: Sentenac-Chemin 2012" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
