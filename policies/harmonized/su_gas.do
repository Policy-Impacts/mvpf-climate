...
/*Su, Qing. 
"The effect of population density, road network density, and congestion on household gasoline consumption in US urban areas." 
Energy Economics 33, no. 3 (2011): 445-452. */
*https://www.sciencedirect.com/science/article/pii/S0140988310001933
*/
...
global color_group5_`1' = 14
	...
	global `1'_ep = "N"
	global `1'_name "Gasoline Tax (Price Elasticity from Su 2011)"
...
global note_`1' = `"Publication: Su 2011" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
