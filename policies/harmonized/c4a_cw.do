*************************************************************************************
/*       0. Program: Energy Efficient Appliance Rebate -- STAR Clothes Washers        */
*************************************************************************************
...
local clothes_washer_energy_savings = (((`first5_loss' * `energy_cost') + ((`first5_loss' * `energy_cost') / `discount') * (1 - (1 / (1 + `discount')^(`shift_factor' - 1)))) + ///
