...
*https://onlinelibrary.wiley.com/doi/pdf/10.1002/jae.2500?casa_token=tua1MHBeVaAAAAAA:XorqSygTiIj2O0WtjfJ-ohSVC1WPgUv3ZtaYs7DOYDKBov2yqJLP6uEHkKakDOc0Dw8kFn1PId1kyM137g
*/
...
global `1'_ep = "N"
global `1'_name "Gasoline Tax (Price Elasticity from Coglianese et al. 2017)"
...
global note_`1' = `"Publication: Coglianese et al. 2017" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (${today_year} dollars). `cc_note_gas_taxes' "'
