...
local standard_wh_cost = (420 * 17.6 + 620 * 6.1 + 485 * 10.1 + 665 * 10.4) / (17.6 + 6.1 + 10.1 + 10.4)
local es_wh_cost = (645 * 0.6 + 969 * 0.5 + 700 * 0.2 + 1020 * 0.7) / (0.6 + 0.5 + 0.2 + 0.7)
local wh_cost = (`es_wh_cost' - `standard_wh_cost') * (${cpi_2020} / ${cpi_${policy_year}})
di in red "wh cost is `wh_cost'"

local water_heater_cost = `wh_cost'

local resource_cost = `water_heater_cost' - `water_heater_energy_savings'
