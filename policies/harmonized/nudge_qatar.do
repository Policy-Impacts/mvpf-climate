...
Omar Al-Ubaydli, Alecia W. Cassidy, Anomitro Chatterjee, Ahmed Khalifa, Michael K. Price
...
****************************************************
	...
	****************************************************
	*Emissions numbers from: https://www.statista.com/statistics/1302666/qatar-emissions-intensity-from-electricity-generation/#:~:text=Emissions%20intensity%20from%20electricity%20generation%20in%20Qatar%202011%2D2020&text=In%202020%2C%20the%20emissions%20intensity,compared%20to%20the%20previous%20year.
	
	local tons_per_gram = .0000011023
	
	*Do not have reliable non-CO2 numbers for Qatar grid, so I am using CO2eq instead
	local SO2_per_kwh = 0
	local NOx_per_kwh = 0
	
	local CO2_per_kwh = ${sc_CO2_`dollar_year'} * (${cpi_`dollar_year'}/${cpi_2020}) * 489.97 * `tons_per_gram'
