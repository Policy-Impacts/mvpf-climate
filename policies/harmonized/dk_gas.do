...
*https://onlinelibrary.wiley.com/doi/pdf/10.1002/jae.1156?casa_token=NvTuVmTc4IIAAAAA:X4am44dRQ8ZnnKjP3iBy9P5qmc5xze5xeyJqNICk1rfwlwZnPKfJEe3pDnRvW6TmOV-u-TrIkpK8206Vgw
*/
...
global color_group5_`1' = 14
	...
	global `1'_ep = "N"
	global `1'_name "Gasoline Tax (Price Elasticity from Davis and Kilian 2011)"
...
global note_`1' = `"Publication: Davis and Kilian 2011" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (${today_year} dollars). `cc_note_gas_taxes' "'
