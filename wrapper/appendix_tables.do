...
*----------------------------------------------------------
* 6 - Baseline MVPF Components Using an SCC of $1367 in 2020
*----------------------------------------------------------

do "${github}/figtab/excel_MVPF_tables.do" "full_current_1367" "App_Table6_scc1367_main" "no" "yes"

*---------------------------------------------------------
* 7 - Baseline MVPF Components Excluding Learning by Doing
*---------------------------------------------------------

do "${github}/figtab/excel_MVPF_tables.do" "full_current_no_lbd" "App_Table7_no_lbd" "no" "no"
...
*-----------------------------------------------
* 9 - Baseline MVPF Components Excluding Profits
*-----------------------------------------------

do "${github}/figtab/excel_MVPF_tables.do" "full_current_noprofits" "App_Table9_no_profits" "no" "no"

*--------------------------------------------------------------------------
* 10 - Baseline MVPF Components Including Energy Savings Additional Benefits
*--------------------------------------------------------------------------

do "${github}/figtab/excel_MVPF_tables.do" "full_current_savings" "App_Table10_with_savings" "yes"

*--------------------------------------------------------
* 11 - MVPF Versus Cost Per Ton Measures for All Policies
*--------------------------------------------------------
