...
for mode = 2:4
        for s= 1:length(samples)
            ...
            includeinestimation=logical(estimation_condition(:,1) & data.abs_t_stat<=threshold & data.t_stat > 0 - 1e19*keep_neg);
           % includeinestimation2 = data.abs_t_stat<=threshold
            ...
            Psihat0=[0,10,1];    % [mean, sd of underlying dist., betap(1), betap(2)]
            ...
            symmetric_cutoffs = abs(sum(cutoffs))<= 1e-6; 
