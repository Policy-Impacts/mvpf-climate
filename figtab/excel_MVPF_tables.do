	...
	if "`export_excel_toggle'" == "yes" {
		...
		if "`savings'" == "no" {
			...
			if "`with_international'" == "no" {
				copy "${output_tab}/tables_templates/TEMPLATE_No_International.xlsx" "`output_path'/`table_name'.xlsx", replace	
			}
